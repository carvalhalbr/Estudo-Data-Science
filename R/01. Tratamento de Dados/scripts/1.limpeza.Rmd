...
dados = read.csv("E:\\DATA_SCIENCE\\R\\01. Tratamento de Dados\\src\\dados\\Churn.csv", sep = ";", na.strings="", stringsAsFactors=T)
head(dados)
summary(dados)
```
Colunas
...
summary(dados$Salario)
#ver mediana
median(dados$Salario,na.rm = T) # necessario manter os dados NA para cálcular a mediana
...
# "" , M em Masculino (moda) (Os valores NA serão atribuido ao valor masculino, pois ele é o que mais ocorre ou seja a moda)
